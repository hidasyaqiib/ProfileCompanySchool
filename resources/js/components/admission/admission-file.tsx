...
const documents: Document[] = [
    ...
    },
    {
        ...
        title: 'Fotocopy Ijazah RA/TK',
        description: 'Fotocopy ijazah atau surat keterangan lulus dari RA/TK.',
        quantity: '1 lembar',
        required: true,
    },
    {
        icon: <FileText size={18} />,
        title: 'Fotocopy Akta Kelahiran',
        description: 'Fotocopy akta kelahiran calon peserta didik.',
        quantity: '1 lembar',
        required: true,
    },
    {
        icon: <CreditCard size={18} />,
        title: 'Fotocopy KTP Orang Tua',
        description: 'Fotocopy KTP ayah dan ibu atau wali yang sah.',
        quantity: '1 lembar',
        required: true,
    },
    {
    ...
    },
    {
        icon: <Camera size={18} />,
        title: 'Pas Photo 3x4',
        description: 'Pas foto berwarna terbaru calon peserta didik.',
        quantity: '3 lembar',
        required: true,
    },
    {
        icon: <FileText size={18} />,
        title: 'Fotocopy Kartu PKH/KIP',
        description:
            'Fotocopy Kartu Program Keluarga Harapan (PKH) atau Kartu Indonesia Pintar (KIP) jika ada.',
        quantity: '1 lembar',
        required: false,
    },
];
