...
const AdmissionFlow: React.FC = () => {
    ...
    return (
        <section
            ref={containerRef}
            className="relative bg-white px-4 py-20 md:px-16"
        >
            {/* Header */}
            <motion.div
            ...
            >
                ...
                <p className="font-poppins mx-auto mt-3 max-w-2xl text-sm text-gray-500 md:text-base">
                    Ikuti setiap tahapan berikut untuk mendaftarkan putra-putri
                    Anda di MI NU 02 Situwangi dengan lancar.
                </p>
            </motion.div>
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl bg-[#2ECC71]/10 text-[#2ECC71] transition-colors duration-300 group-hover:bg-[#2ECC71] group-hover:text-white">
                                                {step.icon}
                                            </div>
