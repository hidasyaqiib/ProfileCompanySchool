            ...
            <div className="lg:item-center flex min-h-[37.5rem] flex-col px-4 pt-32 md:grid md:grid-cols-2 md:px-16 lg:justify-center">
                ...
                >
                    ...
                    >
                        ...
                        <span className="text-gray-800">Kalender Akademik</span>
                    </motion.p>
                    ...
                    >
                        Kalender{' '}
                        <span className="text-[#2ECC71]">Akademik</span>
                    </motion.h1>
                    ...
                    >
                        Kalender Akademik menyajikan jadwal kegiatan dan agenda
                        resmi sekolah sepanjang tahun ajaran, meliputi kegiatan
                        akademik, event kesiswaan, dan agenda administrasi
                        sekolah.
                    </motion.p>
                </motion.div>
            </div>
