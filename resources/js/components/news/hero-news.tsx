            ...
            <div className="relative container mx-auto px-4 sm:px-6">
                ...
                <div className="mb-6 flex items-center justify-between border-y border-gray-100 py-2.5 sm:mb-8">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs font-semibold tracking-widest text-[#27ae60] uppercase">
                            Informasi Terbaru
                        </span>
                    </div>
                ...
                >
                    ...
                    <h1 className="mb-2 text-center text-5xl leading-none font-black tracking-tighter text-gray-900 sm:text-6xl md:text-8xl lg:text-[9rem]">
                        Berita
                    </h1>

                    {/* School sub-line */}
                    <p className="mb-8 text-center text-xs font-semibold tracking-[0.15em] text-gray-400 uppercase sm:mb-10 sm:tracking-[0.3em]">
                        MI NU 02 Situwangi &mdash; Berita &amp; Informasi
                        Sekolah
                    </p>

                    {/* ── Search bar ────────────────────────────────── */}
                    <div className="mx-auto max-w-2xl px-0 sm:px-4">
                        <div className="flex items-center rounded-2xl bg-white shadow-lg ring-1 shadow-gray-100/80 ring-gray-200 transition-shadow focus-within:ring-2 focus-within:ring-[#2ECC71]/50">
                            ...
                            <input
                                ...
                                className="flex-1 bg-transparent py-3.5 pr-1 pl-2.5 text-sm text-gray-800 placeholder-gray-400 focus:outline-none sm:py-4 sm:pr-2 sm:pl-3"
