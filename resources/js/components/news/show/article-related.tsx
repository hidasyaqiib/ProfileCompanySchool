                            ...
                            <li key={article.id}>
                                ...
                                >
                                    ...
                                    <div className="min-w-0 flex-1 py-0.5">
                                        <h3 className="mb-2 line-clamp-2 text-sm leading-snug font-bold text-gray-900 transition-colors group-hover:text-[#27ae60]">
                                            {article.title}
                                        </h3>
                                    ...
                                    {/* Arrow icon */}
                                    <ArrowUpRight className="h-3.5 w-3.5 shrink-0 self-center text-gray-200 transition-all group-hover:translate-x-0.5 group-hover:-translate-y-0.5 group-hover:text-[#27ae60]" />
                                </Link>
                            </li>
                        ))}
                    </ul>
